...
const SUPABASE_URL =
  ...
  "https://dubnvfvlaiqzbimgaqvp.supabase.co";
const SUPABASE_KEY =
  import.meta.env.VITE_SUPABASE_KEY ||
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImR1Ym52ZnZsYWlxemJpbWdhcXZwIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTk1MzA0MzAsImV4cCI6MjA3NTEwNjQzMH0.SbQ3dNb7gazStIcmsiLAGswiIOVRC2IaY2Irs6P20Aw";
...
export const dashboardApiService = {
    ...
    try {
      ...
      updatesData.forEach((update) => {
        ...
        if (
          ...
          new Date(channelMap[update.channel].created_at)
        ) {
  ...
  updateChannel: async (
    _id: string,
    _data: { name: string; public: boolean }
  ) => {
    try {
